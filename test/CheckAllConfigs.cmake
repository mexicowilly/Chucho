...
WHILE(NOT YAML_VAL STREQUAL END)
    ...
    EXECUTE_PROCESS(COMMAND "${CMAKE_COMMAND}" -G "${GENERATOR}" -DCLANG_LIBSTDCXX=${CLANG_LIBSTDCXX} -DDISABLE_ZLIB=ON -DDISABLE_BZIP2=ON -DYAML_CONFIG=${YAML_VAL} -DCONFIG_FILE_CONFIG=${CONFIG_VAL} -DLOG4CPLUS_CONFIG=${LOG4CPLUS_VAL} "${CHUCHO_SOURCE_DIR}"
