...
#if !defined(CHUCHO_INTERVAL_FILE_ROLL_TRIGGER_FACTORY_HPP__)
#define CHUCHO_INTERVAL_FILE_ROLL_TRIGGER_FACTORY_HPP__
...
class interval_file_roll_trigger_factory : public configurable_factory
{
public:
