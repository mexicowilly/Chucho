...
#if !defined(CHUCHO_BZIP2_COMPRESSOR_H__)
#define CHUCHO_BZIP2_COMPRESSOR_H__

/**
 * @file 
 * @copydoc chucho::bzip2_compressor 
 *  
 ...
 *         failure
 */
CHUCHO_EXPORT chucho_rc chucho_create_bzip2_compressor(chucho_compressor** cmp);
