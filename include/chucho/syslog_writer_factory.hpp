...
#if !defined(CHUCHO_SYSLOG_WRITER_FACTORY_HPP__)
#define CHUCHO_SYSLOG_WRITER_FACTORY_HPP__
...
class syslog_writer_factory : public writer_factory
{
public:
    syslog_writer_factory();
