...
#if !defined(CHUCHO_NOOP_COMPRESSOR_FACTORY_HPP__)
#define CHUCHO_NOOP_COMPRESSOR_FACTORY_HPP__
...
class noop_compressor_factory : public configurable_factory
{
public:
    noop_compressor_factory();
