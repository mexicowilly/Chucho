...
#if !defined(CHUCHO_FLATBUFFERS_SERIALIZER_FACTORY_HPP__)
#define CHUCHO_FLATBUFFERS_SERIALIZER_FACTORY_HPP__
...
class flatbuffers_serializer_factory : public configurable_factory
{
public:
    flatbuffers_serializer_factory();
