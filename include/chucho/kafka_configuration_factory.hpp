...
#if !defined(CHUCHO_KAFKA_CONFIGURATION_FACTORY_HPP__)
#define CHUCHO_KAFKA_CONFIGURATION_FACTORY_HPP__
...
class kafka_configuration_factory : public configurable_factory
{
public:
    kafka_configuration_factory();
