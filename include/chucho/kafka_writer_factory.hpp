...
#if !defined(CHUCHO_KAFKA_WRITER_FACTORY_HPP__)
#define CHUCHO_KAFKA_WRITER_FACTORY_HPP__
...
class kafka_writer_factory : public writer_factory
{
public:
    kafka_writer_factory();
