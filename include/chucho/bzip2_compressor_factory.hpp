...
#if !defined(CHUCHO_BZIP2_COMPRESSOR_FACTORY_HPP__)
#define CHUCHO_BZIP2_COMPRESSOR_FACTORY_HPP__
...
class bzip2_compressor_factory : public configurable_factory
{
public:
