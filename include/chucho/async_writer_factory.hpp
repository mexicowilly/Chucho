...
#if !defined(CHUCHO_ASYNC_WRITER_FACTORY_HPP__)
#define CHUCHO_ASYNC_WRITER_FACTORY_HPP__
...
class async_writer_factory : public configurable_factory
{
public:
    async_writer_factory();
