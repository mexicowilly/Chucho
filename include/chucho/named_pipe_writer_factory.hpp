...
#if !defined(CHUCHO_NAMED_PIPE_WRITER_FACTORY_HPP__)
#define CHUCHO_NAMED_PIPE_WRITER_FACTORY_HPP__
...
class named_pipe_writer_factory : public writer_factory
{
public:
    named_pipe_writer_factory();
