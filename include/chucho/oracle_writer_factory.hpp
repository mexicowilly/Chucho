...
#if !defined(CHUCHO_ORACLE_WRITER_FACTORY_HPP__)
#define CHUCHO_ORACLE_WRITER_FACTORY_HPP__
...
class oracle_writer_factory : public writer_factory
{
public:
    oracle_writer_factory();
