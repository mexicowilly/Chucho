...
#if !defined(CHUCHO_GZIP_FILE_COMPRESSOR_H__)
#define CHUCHO_GZIP_FILE_COMPRESSOR_H__
 ...
 *         failure
 */
CHUCHO_EXPORT chucho_rc chucho_create_gzip_file_compressor(chucho_file_compressor** cmp, unsigned min_index);
