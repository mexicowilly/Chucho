...
#if !defined(CHUCHO_LZMA_COMPRESSOR_FACTORY_HPP__)
#define CHUCHO_LZMA_COMPRESSOR_FACTORY_HPP__
...
class lzma_compressor_factory : public configurable_factory
{
public:
    lzma_compressor_factory();
