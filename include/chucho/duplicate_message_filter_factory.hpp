...
#if !defined(CHUCHO_DUPLICATE_MESSAGE_FILTER_FACTORY_HPP__)
#define CHUCHO_DUPLICATE_MESSAGE_FILTER_FACTORY_HPP__
...
class duplicate_message_filter_factory : public configurable_factory
{
public:
