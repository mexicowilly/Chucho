...
#if !defined(CHUCHO_YAML_FORMATTER_FACTORY_HPP__)
#define CHUCHO_YAML_FORMATTER_FACTORY_HPP__
...
class yaml_formatter_factory : public configurable_factory
{
public:
    yaml_formatter_factory();
