...
#if !defined(CHUCHO_SLIDING_NUMBERED_FILE_ROLLER_MEMENTO_HPP_)
#define CHUCHO_SLIDING_NUMBERED_FILE_ROLLER_MEMENTO_HPP_
...
{
public:
    sliding_numbered_file_roller_memento(configurator& cfg);
