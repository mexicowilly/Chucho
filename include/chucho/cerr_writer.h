...
#if !defined(CHUCHO_CERR_WRITER_H__)
#define CHUCHO_CERR_WRITER_H__
 ...
 *         failure
 */
CHUCHO_EXPORT chucho_rc chucho_create_cerr_writer(chucho_writer** wrt, chucho_formatter* fmt);
