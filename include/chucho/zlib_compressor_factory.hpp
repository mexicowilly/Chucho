...
#if !defined(CHUCHO_ZLIB_COMPRESSOR_FACTORY_HPP__)
#define CHUCHO_ZLIB_COMPRESSOR_FACTORY_HPP__
...
class zlib_compressor_factory : public configurable_factory
{
public:
    zlib_compressor_factory();
