...
#if !defined(CHUCHO_LZMA_FILE_COMPRESSOR_H__)
#define CHUCHO_LZMA_FILE_COMPRESSOR_H__

/**
 * @file
 * Creation of lzma file compressors.
 * @copydoc chucho::lzma_file_compressor
 *
...
/**
 * Create an LZMA file compressor.
 *
 ...
 *         failure
 */
CHUCHO_EXPORT chucho_rc chucho_create_lzma_file_compressor(chucho_file_compressor** cmp, unsigned min_index);
