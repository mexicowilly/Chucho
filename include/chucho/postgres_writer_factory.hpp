...
#if !defined(CHUCHO_POSTGRES_WRITER_FACTORY_HPP__)
#define CHUCHO_POSTGRES_WRITER_FACTORY_HPP__
...
class postgres_writer_factory : public writer_factory
{
public:
    postgres_writer_factory();
